...
rtw_image::rtw_image() : data(nullptr) {}
...
int rtw_image::width()  const { return (data == nullptr) ? 0 : image_width; }
int rtw_image::height() const { return (data == nullptr) ? 0 : image_height; }
